...
function NetworkEnvDetailsHome() {
        ...
        <Form layout={"vertical"} form={form}>
          ...
          <Row gutter={16}>
            ...
            <Col xxl={12} xl={12} lg={12} md={12}>
              ...
              >
                <Input placeholder="Enter Network Behavior" />
              </Form.Item>
            </Col>
          </Row>
...
export default NetworkEnvDetailsHome;
